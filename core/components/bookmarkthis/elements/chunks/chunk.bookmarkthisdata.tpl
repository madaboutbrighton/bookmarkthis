{
  "delicious":{
      ...
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/delicious-{type}.png"
    }, 
  "digg":{
      "name" : "Digg",
      "share" : "https://digg.com/submit?url={link}&title={title}",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/digg-{type}.png"
    },
  "evernote":{
      "name" : "Evernote",
      "share" : "https://www.evernote.com/clip.action?url={link}",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/evernote-{type}.png"
    },
  "facebook":{
      "name" : "Facebook",
      "share" : "https://www.facebook.com/sharer/sharer.php?u={link}&t={title}",
      "follow" : "https://www.facebook.com/",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/facebook-{type}.png"
    },
  "github":{
      "name" : "Github",
      "follow" : "https://github.com/",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/github-{type}.png"
    }, 
  "google":{
      "name" : "Google",
      "share" : "https://www.google.com/bookmarks/mark?op=edit&output=popup&bkmk={link}&title={title}&labels={tags}",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/google-{type}.png"
    }, 
  "linkedin":{
      "name" : "LinkedIn",
      ...
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/linkedin-{type}.png"
    }, 
  "newsvine":{
      "name" : "Newsvine",
      "share" : "https://www.newsvine.com/_tools/seed?popoff=0&u={link}&title={title}",
            "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/newsvine-{type}.png"
    }, 
  "pinterest":{
      "name" : "Pinterest",
      "share" : "https://www.pinterest.com/pin/create/button?url={link}&media=&description={title}",
      "follow" : "https://www.pinterest.com/",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/pinterest-{type}.png"
    }, 
  "reddit":{
      "name" : "Reddit",
      "share" : "https://reddit.com/submit?url={link}&title={title}",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/reddit-{type}.png"
    }, 
  "twitter":{
      "name" : "Twitter",
      "share" : "https://twitter.com/intent/tweet?text={title}&url={link}",
      "follow" : "https://twitter.com/",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/twitter-{type}.png"
    }, 
  "email":{
      "name" : "E-mail",
      "share" : "mailto:?subject={title}&body={link}",
      "image" : "{bookmarkthis_assets_url}/images/v1.6/{size}/email-{type}.png"
    }
}