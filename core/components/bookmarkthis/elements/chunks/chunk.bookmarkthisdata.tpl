{
  "blogger":{
      ...
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/blogger-{type}.png"
    },
  "digg":{
      "name" : "Digg",
      "share" : "https://digg.com/submit?url={link}&title={title}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/digg-{type}.png"
    },
  "evernote":{
      "name" : "Evernote",
      "share" : "https://www.evernote.com/clip.action?url={link}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/evernote-{type}.png"
    },
  "facebook":{
      "name" : "Facebook",
      "share" : "https://www.facebook.com/sharer/sharer.php?u={link}&t={title}",
      "follow" : "https://www.facebook.com/",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/facebook-{type}.png"
    },
  "flipboard":{
      "name" : "Flipboard",
      "share" : "https://share.flipboard.com/bookmarklet/popout?v=2&title={title}&url={link}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/flipboard-{type}.png"
    },
  "github":{
      "name" : "Github",
      "follow" : "https://github.com/",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/github-{type}.png"
    }, 
  "google":{
      "name" : "Google",
      "share" : "https://www.google.com/bookmarks/mark?op=edit&output=popup&bkmk={link}&title={title}&labels={tags}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/google-{type}.png"
    }, 
  "linkedin":{
      "name" : "LinkedIn",
      ...
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/linkedin-{type}.png"
    }, 
  "pinterest":{
      "name" : "Pinterest",
      "share" : "https://www.pinterest.com/pin/create/button?url={link}&media=&description={title}",
      "follow" : "https://www.pinterest.com/",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/pinterest-{type}.png"
    },
  "pocket":{
      "name" : "Pocket",
      "share" : "https://getpocket.com/save?url={link}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/pocket-{type}.png"
    },
  "reddit":{
      "name" : "Reddit",
      "share" : "https://reddit.com/submit?url={link}&title={title}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/reddit-{type}.png"
    }, 
  "telegram":{
      "name" : "Telegram",
      "share" : "https://t.me/share/url?url={link}&text={title}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/telegram-{type}.png"
    },
  "tumblr":{
      "name" : "Tumblr",
      "share" : "https://www.tumblr.com/widgets/share/tool?canonicalUrl={link}&title={title}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/tumblr-{type}.png"
    },
  "twitter":{
      "name" : "Twitter",
      "share" : "https://twitter.com/intent/tweet?text={title}&url={link}",
      "follow" : "https://twitter.com/",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/twitter-{type}.png"
    },
  "vk":{
      "name" : "VK",
      "share" : "https://vk.com/share.php?url={link}",
      "follow" : "https://vk.com/",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/vk-{type}.png"
    },
  "youtube":{
      "name" : "Youtube",
      "follow" : "https://www.youtube.com/",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/youtube-{type}.png"
    }, 
  "email":{
      "name" : "E-mail",
      "share" : "mailto:?subject={title}&body={link}",
      "image" : "{bookmarkthis_assets_url}images/v1.7/{size}/email-{type}.png"
    }
}